...
export const ABOUT: AboutElement[] = [
  ...
  },
  {
    ...
    subtitle: "Newsletters are great for keeping up with all the news and everything changing in the industry. Today's newsletters help save time by providing great articles, tips, useful resources, learning more about a topic that interests you, and so on. I'm getting addicted to newsletters now.",
    type: "hyperlink",
    descriptions: [
      "Android Weekly",
      "Kotlin Weekly",
      ...
      "Frontend Focus",
      "ByteByteGo",
      "The Transcript - Weekly Quotes From Earning Calls",
    ],
    urls: [
